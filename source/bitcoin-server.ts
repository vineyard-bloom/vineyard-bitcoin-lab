...
export class BitcoinServer {
  ...
  start(conf=null) {
    ...
    const rpcUser = '-rpcuser=' + conf.rpcuser
    const rpcPass = '-rpcpassword=' + conf.rpcpassword
    const childProcess = this.childProcess = child_process.spawn('bitcoind', [rpcUser, rpcPass])
